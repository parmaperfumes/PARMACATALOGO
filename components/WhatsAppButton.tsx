	...
	return (
		<>
			...
			>
				...
				{items.length > 0 && (
					<span className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 bg-red-500 text-white text-[10px] sm:text-xs font-bold rounded-full min-w-[18px] sm:min-w-[20px] h-4.5 sm:h-5 px-1 sm:px-1.5 flex items-center justify-center border-2 border-white">
