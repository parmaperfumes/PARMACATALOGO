...
import { idsNuevos, quedanValido } from "@/lib/sello"
...
export default async function PerfumesPage() {
	...
	// «Nuevo» lo llevan solos los 3 agregados más recientes, entre los que se ven.
	const nuevos = idsNuevos(perfumes)
	perfumes = perfumes.map((p) => ({ ...p, esNuevo: nuevos.has(p.id) }))
