...
// «Más vendido». Desde el 2026-09-23 ninguno sale de la marca del admin: «Nuevo» lo
// llevan los 3 agregados más recientes, «Más vendido» el top 5 de ventas que calcula
// Labs (el del Dashboard), y «Re-stock» no se muestra.
...
export function selloDe(p: {
	...
	if (p.masVendido === true) return { texto: "Más vendido", tono: "vendido" }
	return null
}
